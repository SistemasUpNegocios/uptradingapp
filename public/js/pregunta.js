...
$(document).ready(function () {
    ...
    var table = $("#pregunta").DataTable({
        ajax: "/admin/showPreguntas",
        columns: [
            { data: "pregunta" },
            { data: "informacion" },
            { data: "btn" },
        ...
        $.ajax({
            ...
            success: function () {
                ...
                if (acc == "new") {
                    Swal.fire({
                        icon: "success",
                        title: '<h1 style="font-family: Poppins; font-weight: 700;">Pregunta añadida</h1>',
                        html: '<p style="font-family: Poppins">La pregunta ha sido añadida correctamente</p>',
                        confirmButtonText:
                    ...
                    Swal.fire({
                        icon: "success",
                        title: '<h1 style="font-family: Poppins; font-weight: 700;">Pregunta actualizada</h1>',
                        html: '<p style="font-family: Poppins">La pregunta ha sido actualizada correctamente</p>',
                        confirmButtonText:
                            '<a style="font-family: Poppins">Aceptar</a>',
                        confirmButtonColor: "#01bbcc",
                    });
    ...
    $(document).on("click", ".edit", function (e) {
        ...
        $("#btnSubmit").show();
        $("#btnSubmit").text("Editar pregunta");
        $("#btnCancel").text("Cancelar");
    });
    ...
    $(document).on("click", ".delete", function (e) {
        ...
        Swal.fire({
            title: '<h1 style="font-family: Poppins; font-weight: 700;">Eliminar pregunta</h1>',
            html: '<p style="font-family: Poppins">¿Estás seguro de eliminar esta pregunta? esta opción no se puede deshacer</p>',
            icon: "warning",
            ...
            if (result.value) {
                $.post("/admin/deletePregunta", { id: id }, function () {
                    table.ajax.reload(null, false);
                    Swal.fire({
                        icon: "success",
                        title: '<h1 style="font-family: Poppins; font-weight: 700;">Pregunta eliminada</h1>',
                        html: '<p style="font-family: Poppins">La pregunta se ha eliminado correctamente</p>',
                        confirmButtonText:
                            '<a style="font-family: Poppins">Aceptar</a>',
                        confirmButtonColor: "#01bbcc",
                    });
                ...
                Swal.fire({
                    ...
                    html: '<p style="font-family: Poppins">La pregunta no se ha eliminado</p>',
                    confirmButtonText:
                        '<a style="font-family: Poppins">Aceptar</a>',
                    confirmButtonColor: "#01bbcc",
                });
