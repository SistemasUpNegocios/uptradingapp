...
$(document).ready(function () {
    ...
    var table = $("#pagoCliente").DataTable({
        ajax: "/admin/showClientePago",
        columns: [
            {
                data: "codigoCliente",
            },
    ...
    $("#pagoClienteForm").on("submit", function (e) {
        e.preventDefault();
        ...
        $.ajax({
            ...
            success: function () {
                ...
                $("#pagoClienteForm")[0].reset();
                table.ajax.reload(null, false);
                if (acc == "edit") {
                    Swal.fire({
                        icon: "success",
                        title: '<h1 style="font-family: Poppins; font-weight: 700;">Pago a cliente actualizado</h1>',
                        html: '<p style="font-family: Poppins">El pago a cliente ha sido actualizado correctamente</p>',
                        confirmButtonText:
    ...
    $(document).on("click", ".view", function (e) {
        ...
        var clientenombre = $(this).data("clientenombre");
        ...
        if (comprobante == "") {
            ...
            $(".file-upload-image").attr(
                "src",
                "/img/comprobantes/pagocliente/" + comprobante
            );
            $(".file-upload-content").show();
        ...
        $("#modalTitle").text(
            `Vista previa de pago a ${clientenombre} del contrato ${contrato} al mes ${serie}`
        );
    ...
    $(document).on("click", ".edit", function (e) {
        ...
        $("#formModal").modal("show");
        $("#pagoClienteForm").attr("action", "/admin/editPagosCliente");
        ...
        $("#modalTitle").text(`Editar pago a cliente: ${contrato}`);
        $("#btnSubmit").show();
        $("#btnSubmit").text("Editar pago a cliente");
    ...
    $(document).on("click", "#seeContrato", function (e) {
        ...
        $("#modalTitle").text(`Vista previa del contrato de: ${clientenombre}`);
    ...
    $(document).on("click", "#seePagos", function (e) {
        ...
        let id = $(this).data("clienteid");
        let clientenombre = $(this).data("clientenombre");

        $(".titlePage").text(`Cliente ${clientenombre}`);

        table = $("#pagoCliente").DataTable({
            ajax: {
                url: "/admin/showContratosCliente",
                type: "GET",
                data: {
                    clienteid: id,
                },
        ...
        $("#btnVolver").empty();
        $("#btnVolver").append(
            '<i class="bi-chevron-left me-1"></i>Ver todos los clientes'
        );

        $(document).on("click", "#btnVolver", function (e) {
            $(".titlePage").text(`Gestión de pagos a clientes`);
    ...
    $(document).on("click", "#seePagosCliente", function (e) {
        e.preventDefault();
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                <tbody id="pagoClienteBody">
                </tbody>
                `);

                table = $("#pagoCliente").DataTable({
                    ajax: {
                        url: "/admin/showPagosCliente",
                        data: {
                            contratoid: contratoid,
                        },
                    },
