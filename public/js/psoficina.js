$(document).ready(function () {
    ...
    $(document).on("click", ".new", function (e) {
        $("#alertMessage").text("");
        acc = "new";
        $("#psForm").attr("action", "/admin/addPsOficina");
        $("#idInput").val("");
        ...
        $("#psEncargadoIdInput").prop("disabled", false);
    ...
    $(document).on("click", ".view", function (e) {
        ...
        var encargadoid = $(this).data("encargadoid");
        ...
        var id = $("option:selected", "#oficinaIdInput").val();

        $.ajax({
            type: "POST",
            url: "/admin/getPsEncargado",
            data: { id: id },
            success: function (response) {
                $("#contEncargado").show();
                $("#contEncargado").html(response);

                console.log(encargadoid);

                $("#psEncargadoIdInput").val(encargadoid);
                $("#psEncargadoIdInput").prop("disabled", true);
            },
            error: function (jqXHR, exception) {},
        });
    ...
    $(document).on("click", ".edit", function (e) {
        ...
        $("#formModal").modal("show");
        $("#psForm").attr("action", "/admin/editPsOficina");
    ...
    $(document).on("click", ".delete", function (e) {
        ...
        Swal.fire({
            ...
            if (result.value) {
                $.post("/admin/deletePsOficina", { id: id }, function () {
                    table.ajax.reload(null, false);
                    Swal.fire({
                        icon: "success",
    ...
    $("#oficinaIdInput").on("change", function (event) {
