$(document).ready(function () {
        ...
        $("#contTabla").html(
            `
                <div class="text-center mt-4">
                    ...
                    <p style="color: #01bbcc">Cargando número de contratos de clientes<span class="dotting"> </span></p>
                </div>
            `
        );
    ...
    $(document).on("click", "#imprimirReporte", function (e) {
        ...
        window.open(
            `/admin/imprimir-reporte-conteo-contratos-clientes?inicio=${inicio}&fin=${fin}&dolar=${dolar}`,
            "_blank"
        );
    });
});
