...
$(document).ready(function () {
    ...
    var table1 = $("#folio").DataTable({
        ajax: "/admin/showFolio",
        columns: [
            { data: "folio" },
            { data: "contrato" },
            { data: "estatus" },
        ...
        language: {
            ...
            lengthMenu: "Mostrar _MENU_ folios",
            zeroRecords: "No se encontraron resultados",
            emptyTable: "No se ha registrado ningún folio",
            infoEmpty: "Mostrando folios del 0 al 0 de un total de 0 folios",
            infoFiltered: "(filtrado de un total de _MAX_ folios)",
            search: "Buscar:",
            infoThousands: ",",
            ...
            info: "Mostrando de _START_ a _END_ de _TOTAL_ folios",
        },
        order: [[0, "desc"]],
    });

    var table2 = $("#folioCancelado").DataTable({
        ajax: "/admin/showFolioCancelado",
        columns: [
            { data: "folio" },
            { data: "contrato" },
            { data: "estatus" },
        ...
        language: {
            processing: "Procesando...",
            lengthMenu: "Mostrar _MENU_ folios cancelados",
            zeroRecords: "No se encontraron resultados",
            emptyTable: "No se ha registrado ningún folio",
            infoEmpty:
                "Mostrando folios del 0 al 0 de un total de 0 folios cancelados",
            infoFiltered: "(filtrado de un total de _MAX_ folios cancelados)",
            search: "Buscar:",
            infoThousands: ",",
            loadingRecords: "Cargando...",
            paginate: {
            ...
            info: "Mostrando de _START_ a _END_ de _TOTAL_ folios cancelados",
        },
        order: [[0, "desc"]],
    });
        ...
        $.ajax({
            ...
            success: function () {
                ...
                if (acc == "new") {
                    Swal.fire({
                        icon: "success",
                        title: '<h1 style="font-family: Poppins; font-weight: 700;">Folio añadido</h1>',
                        html: '<p style="font-family: Poppins">El folio ha sido añadido correctamente</p>',
                        confirmButtonText:
                    ...
                    Swal.fire({
                        icon: "success",
                        title: '<h1 style="font-family: Poppins; font-weight: 700;">Folio actualizado</h1>',
                        html: '<p style="font-family: Poppins">El folio ha sido actualizado correctamente</p>',
                        confirmButtonText:
                            '<a style="font-family: Poppins">Aceptar</a>',
                        confirmButtonColor: "#01bbcc",
                    });
    ...
    $(document).on("click", ".view", function (e) {
        ...
        $("#modalTitle").text("Vista previa del folio");
        ...
        $("#contratoIdInput").prop("disabled", true);
        ...
        $("#fechaCanceladoInput").prop("readonly", true);
    ...
    $(document).on("click", ".delete", function (e) {
        ...
        Swal.fire({
            title: '<h1 style="font-family: Poppins; font-weight: 700;">Eliminar folio</h1>',
            html: '<p style="font-family: Poppins">¿Estás seguro de eliminar este folio? esta opción no se puede deshacer</p>',
            icon: "warning",
            ...
            if (result.value) {
                $.post("/admin/deleteFolio", { id: id }, function () {
                    table1.ajax.reload(null, false);
                    table2.ajax.reload(null, false);
                    Swal.fire({
                        icon: "success",
                        title: '<h1 style="font-family: Poppins; font-weight: 700;">Folio eliminado</h1>',
                        html: '<p style="font-family: Poppins">El folio se ha eliminado correctamente</p>',
                        confirmButtonText:
                            '<a style="font-family: Poppins">Aceptar</a>',
                        confirmButtonColor: "#01bbcc",
                    });
                ...
                Swal.fire({
                    ...
                    html: '<p style="font-family: Poppins">El folio no se ha eliminado</p>',
                    confirmButtonText:
                        '<a style="font-family: Poppins">Aceptar</a>',
                    confirmButtonColor: "#01bbcc",
                });
