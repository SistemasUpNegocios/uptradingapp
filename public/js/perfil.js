        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if (acc == "edit") {
                    ...
                    $("#perfilApellidop").text(result.apellido_p);
                    $("#perfilApellidom").text(result.apellido_m);

                    $("#perfilNombreCard").text(result.nombre);
                    $("#perfilApellidopCard").text(result.apellido_p);

                    $("#nombreTitle").text(result.nombre);
                    $("#apellidoPatTitle").text(result.apellido_p);
                    $("#apellidoMatTitle").text(result.apellido_m);

                    $("#nombreInput").val(result.nombre);
                    $("#apellidoPatInput").val(result.apellido_p);
                    $("#apellidoMatInput").val(result.apellido_m);
                    ...
                    $("#nombreSide").text(
                        `${result.nombre} ${result.apellido_p}`
                    );
                    $("#nombreCompletoSide").text(
                        `${result.nombre} ${result.apellido_p} ${result.apellido_m}`
                    );
                }
            },
