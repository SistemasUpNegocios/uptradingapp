...
class AgendaController extends Controller
{
    ...
    public function addAgenda(Request $request)
    {
        ...
        // $client->setSubject("administracion@upnegocios.com");


        $jsonKey = [
            "web" => [
                "client_id" => "108884148413-ksl8vhccm5i4l02kfkkuc214mvg5ioch.apps.googleusercontent.com",
                "project_id" => "inspired-alcove-370018",
                "auth_uri" => "https://accounts.google.com/o/oauth2/auth",
                "token_uri" => "https://oauth2.googleapis.com/token",
                "auth_provider_x509_cert_url" => "https://www.googleapis.com/oauth2/v1/certs",
                "client_secret" => "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"
            ]
         ];
        $client = new \Google\Client();
        $client->setApplicationName("Calendario Google");
        $client->setSubject("administracion@upnegocios.com");
        $client->setAuthConfig($jsonKey);
        $service = new \Google_Service_Calendar($client);

        $calendarId = "administracion@upnegocios.com";
        ...
        // $event->name = 'Prueba de evento';
        // $event->description = 'Prueba de descripción';
        // $event->startDateTime = Carbon::now();
        // $event->endDateTime = Carbon::now()->addHour();
        // $event->addAttendee([
        //     'email' => 'paolarosales@uptradingexperts.com',
        //     'name' => 'Paola Rosales',
        //     'comment' => 'Tienes nueva cita',
        // ]);
    ...
    public function editAgenda(Request $request)
    {
        ...
        $notificacion = new Notificacion;
        $notificacion->titulo = $request->titulo;
        $notificacion->mensaje = $request->descripcion;
        $notificacion->status = 'Pendiente';
        $notificacion->user_id = $request->asignado_a;
        $notificacion->save();
