...
class ReportePagoPsAnteriorController extends Controller
{
    ...
    public function index()
    {
        if(auth()->user()->is_root || auth()->user()->is_admin || auth()->user()->is_procesos || auth()->user()->is_egresos || auth()->user()->is_ps_diamond){        
            return View('reportepagopsanterior.show');
        }else{
    ...
    public function getResumenPagoPs(Request $request)
    {
        ...
        return response()->view('reportepagopsanterior.tabla', $data, 200);
    }
    ...
    public function getReportePagoPs(Request $request)
    {
        ...
        $pdf = PDF::loadView('reportepagopsanterior.reporte', $data);
