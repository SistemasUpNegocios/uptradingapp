...
class ConteoContratoClienteController extends Controller
{
    ...
    public function index()
    {
        ...
        if (auth()->user()->is_root || auth()->user()->is_admin || auth()->user()->is_procesos){
            return response()->view('conteocontratosclientes.show');
        }else{
    ...
    public function getClientes(Request $request)
    {
        ...
        return response()->view('conteocontratosclientes.tabla', $data, 200);
    }
    ...
    public function imprimirReporte(Request $request)
    {
        ...
        $pdf = PDF::loadView('conteocontratosclientes.imprimir', $data);
