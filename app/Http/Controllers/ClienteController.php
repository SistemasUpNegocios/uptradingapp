...
class ClienteController extends Controller
{
    ...
    public function enviarCorreoCumpleanios()
    {
        $clientes = DB::table('cliente')
            ->select('nombre', 'apellido_p', 'apellido_m', 'correo_institucional', 'correo_personal')
        ...
        foreach ($clientes as $cliente) {
                                        ...
                                        <div class='contenido_mensaje'>
                                            <div class='contenido_mensaje_texto'>
                                                <div class='contenido_mensaje_texto__info'>
                                                    ...
                                                    <br />                                                    
                                                    <p color: #404040;'>
                                                        Si eres de los que cuando te cantan el cumpleaños feliz no sabes dónde meterte, te alegrará saber que sólo lo haremos por correo electrónico. Muchas felicidades! Deseamos que este sea un día especial e inolvidable y que tu cumpleaños sea siempre un punto de partida para nuevas emociones y alegrías.
                                                    </p>
                                                    <br />                                                    
                                                    <br />
                                                    <p color: #404040;'>
            ...
            try {
                ...
                //Recipients
                $mail->setFrom('administracion@uptradingexperts.com', 'Equipo Up Trading Experts');
