...
class ContratoVencerController extends Controller
{
    ...
    public function getContratoVencer ()
    {
        $contrato = DB::table('contrato')
            ...
            // ->where("fecha_renovacion", ">=", "2024-05-01")
