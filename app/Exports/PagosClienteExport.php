...
class PagosClienteExport implements FromCollection,WithHeadings
{
    ...
    */
    ...
    public function collection()
    {
        ...
        ->select(DB::raw("contrato.contrato,  CONCAT(cliente.apellido_p, ' ', cliente.apellido_m, ' ', cliente.nombre) AS clientenombre, pago_cliente.pago, contrato.tipo_id, amortizacion.serie as serie_pago"))
