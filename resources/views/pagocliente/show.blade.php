...
@section('title', 'Gestión de pagos a clientes')
...
@section('content')
    ...
    <div class="pagetitle">
        <h1 class="titlePage">Gestión de pagos a clientes</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ url('/admin/dashboard') }}">Vista general</a></li>
                <li class="breadcrumb-item active titlePage">Gestión de pagos a clientes</li>
            </ol>
        </nav>
    </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body mt-3">
                        <a class="btn principal-button mb-3 new" id="btnVolver"> <i class="bi-chevron-left me-1"></i>Ver todos los clientes</a>
                        <table class="text-center mb-3 mt-5 pt-2 table table-bordered nowrap" style="width: 100%; text-transform: uppercase;" id="pagoCliente">
                            <thead>
                                <tr>
                                    <th data-priority="0" scope="col">Código de cliente</th>
                                    <th data-priority="0" scope="col">Nombre completo</th>
                                    <th data-priority="0" scope="col">Acciones</th>
                                </tr>
                            </thead>
                            <tbody id="pagoClienteBody" style="vertical-align: middle;">
                            </tbody>
                        </table>
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="pagoClienteForm" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn principal-button" id="btnSubmit">Editar pago de cliente</button>
                        </div>
                    </form>
                </div>
            </div>
...
@section('scripts')
    ...
    <script src="{{ asset('js/pagocliente.js') }}"></script>
@endsection