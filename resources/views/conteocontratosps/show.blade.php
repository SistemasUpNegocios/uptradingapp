                ...
                <div class="card">
                    <div class="card-body mt-3">
                        ...
                        <div class="alert alert-primary d-flex align-items-center" role="alert">
                            ...
                            <div>
                                Selecciona una fecha para generar el conteo de contratos o convenios activados. (Si borras cualquier fecha o ambas, el conteo empezará desde el inicio de los registros.)
                            </div>
                        </div>                        
