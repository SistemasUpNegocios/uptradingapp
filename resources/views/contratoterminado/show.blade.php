...
@section('title', 'Gestión de contratos terminados')
...
@section('content')
    <div class="pagetitle">
        <h1>Gestión de contratos terminados</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ url('/admin/dashboard') }}">Vista general</a></li>
                <li class="breadcrumb-item active">Gestión de contratos terminados</li>
            </ol>
        </nav>
    </div>
...
@section('scripts')
    ...
    <script src="{{ asset('js/contratoterminado.js') }}"></script>
@endsection