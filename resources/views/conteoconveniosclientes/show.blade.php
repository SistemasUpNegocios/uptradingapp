...
@section('title', 'Gestión de # convenios clientes')
...
@section('content')
    <div class="pagetitle">
        <h1>Gestión de # convenios clientes</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ url('/admin/dashboard') }}">Vista general</a></li>
                <li class="breadcrumb-item active">Gestión de # convenios clientes</li>
            </ol>
        </nav>
    </div>
...
@section('scripts')
    ...
    <script src="{{ asset('js/conteoconveniosclientes.js') }}"></script>
@endsection