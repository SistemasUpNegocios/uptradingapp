                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" minlength="3" maxlength="70" placeholder="Ingresa el nombre del banco" id="psInput" name="ps_encargado" required>
                                <label for="nombreInput">PS Encargado</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" minlength="15" maxlength="15" placeholder="Ingresa el nombre del banco" id="imeiInput" name="imei" required>
                                <label for="imeiInput">IMEI Tableta</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" minlength="15" maxlength="20" placeholder="Ingresa el nombre del banco" id="macInput" name="mac_wifi" required>
                                <label for="macInput">Mac Wi-Fi tableta</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" minlength="17" maxlength="17" placeholder="Ingresa el nombre del banco" id="serieInput" name="serie" required>
