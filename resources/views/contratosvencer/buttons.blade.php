...
<a href="" data-id="{{ $id }}" data-cliente="{{$clientenombre}}" data-notacontrato="{{$nota_contrato}}" data-contrato="{{$contrato}}" type="button" title="Nota del contrato" class="ms-1 btn @if ($nota_contrato == null) btn-dark @else secondary @endif btn-secondary btn-sm btn-icon edit"> <i class="bi bi-journal-text"></i> Nota</a>
