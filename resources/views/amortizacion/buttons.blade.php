@if (auth()->user()->is_root || auth()->user()->is_admin || auth()->user()->is_procesos || auth()->user()->is_ps_encargado || auth()->user()->is_cliente || auth()->user()->is_cliente_ps_encargado || auth()->user()->is_cliente_ps_asistente || auth()->user()->is_egresos)
