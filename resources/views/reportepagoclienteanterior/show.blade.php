...
@section('title', 'Resumen de pagos de contrato (canelados/terminados) de clientes')
...
@section('content')
    <div class="pagetitle">
        <h1>Resumen de pagos de contrato (canelados/terminados) de clientes</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ url('/admin/dashboard') }}">Vista general</a></li>
                <li class="breadcrumb-item active">Resumen de pagos de contrato (canelados/terminados) de clientes</li>
            </ol>
        </nav>
    </div>
...
@section('scripts')
    ...
    <script src="{{ asset('js/reporte-pagoscliente-anterior.js') }}"></script>
@endsection