...
@section('title', 'Gestión de PS de oficina')
...
@section('content')
    <div class="pagetitle">
        <h1>Gestión de PS de oficina</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ url('/admin/dashboard') }}">Vista general</a></li>
                <li class="breadcrumb-item active">Gestión de PS de oficina</li>
            </ol>
        </nav>
    </div>
                ...
                <div class="card">
                    <div class="card-body mt-3">
                        @if (auth()->user()->is_root)                                    
                            <a class="btn principal-button mb-3 new" data-bs-toggle="modal" data-bs-target="#formModal"> <i class="bi-plus-lg me-1"> </i>Añadir un nuevo PS de oficina</a>
                        @endif
                        <table class="table table-striped table-bordered nowrap" id="ps">
                            <thead>
                                <tr>
                                    <th data-priority="0" scope="col">Código PS</th>
                                    <th data-priority="0" scope="col">Nombre de PS</th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="psForm" method="post">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-floating mb-3">
                                    <input type="number" class="form-control" minlength="5" maxlength="30"
                                        placeholder="Ingresa la INE" id="ineInput" name="ine" required>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" minlength="5" maxlength="30"
                                        placeholder="Ingresa el pasaporte" id="pasaporteInput" name="pasaporte" required>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-12" id="contEncargado">
                            </div>
                        </div>
...
@section('scripts')
    ...
    <script src="{{ asset('js/psoficina.js') }}"></script>
@endsection